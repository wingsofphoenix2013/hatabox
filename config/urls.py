...
from production.api_views import (
...
router.register("refund-documents", ExternalRefundDocumentViewSet)
...
router.register("tolling-orders-register", TollingOrderRegisterLightViewSet, basename="tolling-orders-register")
...
router.register(
    "storage-child-type-options",
    StorageChildTypeOptionViewSet,
    basename="storage-child-type-options",
)
...
router.register(
    "warehouse-production-reservations",
    WarehouseProductionReservationViewSet,
    basename="warehouse-production-reservations",
)

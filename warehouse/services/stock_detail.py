...
def _build_stock_rows(item_id: int) -> List[dict]:
    ...
    units = [
        ...
        for unit in WarehouseUnit.objects.select_related(
            ...
            "storage_place__parent",
            "storage_place__parent__location",
            "storage_place__parent__parent",
            "storage_place__parent__parent__location",
            "storage_place__parent__parent__parent",
            "storage_place__parent__parent__parent__location",
        ).filter(
...
def _build_reserved_stock_rows(item_id: int) -> List[dict]:
    plan_items = list(
        MovementPlanItem.objects.select_related(
            ...
            "warehouse_unit__storage_place__parent",
            "warehouse_unit__storage_place__parent__location",
            "warehouse_unit__storage_place__parent__parent",
            "warehouse_unit__storage_place__parent__parent__location",
            "warehouse_unit__storage_place__parent__parent__parent",
            "warehouse_unit__storage_place__parent__parent__parent__location",
        ).filter(
...
def _build_incoming_rows(item_id: int) -> List[dict]:
    ...
    for order_item in procurement_order_items:
        ...
        rows.append({
            ...
            "organization_id": None,
            "organization_name": None,
            "external_order_id": order_item.order.id,
            "external_order_no": order_item.order.order_no,
            "external_order_created_at": order_item.order.created_at,
            "tolling_order_id": None,
            "tolling_order_no": None,
            "tolling_order_created_at": None,
    ...
    for order_item in tolling_order_items:
        ...
        rows.append({
            ...
            "vendor_id": None,
            "vendor_name": None,
            "organization_id": order_item.order.organization.id,
            "organization_name": order_item.order.organization.name,
            "external_order_id": None,
            "external_order_no": None,
            "external_order_created_at": None,
            "tolling_order_id": order_item.order.id,
            "tolling_order_no": order_item.order.order_no,
            "tolling_order_created_at": order_item.order.created_at,
            **_build_delivery_status(order_item.expected_delivery_date),
            "quantity": remaining,
            "has_unconverted_quantity": False,
        })
